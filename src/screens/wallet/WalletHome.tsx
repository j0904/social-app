...
type Props = NativeStackScreenProps<CommonNavigatorParams, 'WalletHome'>
    ...
    <Layout.Screen>
      ...
      <Layout.Content>
        <SettingsList.Container>
          ...
          <SettingsList.PressableItem
            onPress={() => {
              // Navigate to Keys screen (previously Wallet screen)
              navigate('Wallet') // This uses the global navigate function to reach the Keys screen
            }}
            label={_(msg`Keys`)}>
